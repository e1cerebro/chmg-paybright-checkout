...
class Chmg_Paybright_Checkout_Admin {
	...
	public function chmg_pb_admin_menu(){
			...
			add_submenu_page( 
								'woocommerce', 
								$page_title = __('PayBright Fee Settings', 'chmg_bp'), 
								$menu_title = __('PayBright Fee Settings', 'chmg_bp'), 
								'manage_options', 
	...
	public function chmg_pb_fee_title_cb(){
		$chmg_pb_fee_title=  get_option('chmg_pb_fee_title_el');
		?>
		...
		<p class="description"><?php _e("Enter the Fee Title to be displayed at the checkout page", 'chmg_bp'); ?></p>
	...
	public function chmg_pb_interest_rate_cb(){
		$chmg_pb_interest_rate =  get_option('chmg_pb_interest_rate_el');
		?>
	...
	public function chmg_pb_additional_note_cb(){
		$chmg_pb_additional_note =  get_option('chmg_pb_additional_note_el');
		?>
		...
		<p class="description"><?php _e("Enter the additional note to be displayed at the checkout page.<br/>You can also place shortcodes here<br/> Shortcodes <br/> <strong>Interest Rate:</strong> [interest_fee]", 'chmg_bp'); ?></p>
